...
#
# prepare_output_tables_Gephi_subgraph_all(df = uniq_edgelist, subset_keys = ["active school travel"],
#                             graph_name = "activeschooltravel", harmon_BOs=True)
#
# prepare_output_tables_Gephi_subgraph_all(df = uniq_edgelist, subset_keys = ["driving"],
#                             graph_name = "driving", harmon_BOs=True)
#
# prepare_output_tables_Gephi_subgraph_all(df = uniq_edgelist, subset_keys = ["physical activity"],
#                             graph_name = "pysicalactivity", harmon_BOs=True)
#
# prepare_output_tables_Gephi_subgraph_all(df = uniq_edgelist, subset_keys = ["active travel"],
#                             graph_name = "activetravel", harmon_BOs=True)
#
# prepare_output_tables_Gephi_subgraph_all(df = uniq_edgelist, subset_keys = ["public transport use"],
#                             graph_name = "transit", harmon_BOs=True)

prepare_output_tables_Gephi(df = uniq_edgelist, graph_name = "harmonise_BO_final", Source_col = "BOharm_keys",
                            Target_col = "BD_keys", Source_label = "BehaviorOptionHarmon",
                            Target_label = "BehaviorDeterminant")


######## Former versions before manual harmonisation of Behavior Options
