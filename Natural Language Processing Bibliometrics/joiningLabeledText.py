...
data = pd.read_csv("manually_labeled/labeled_articles_joined.csv", encoding="latin1").fillna("O")
...
print(data)
csv = os.path.join(os.getcwd(), ("manually_labeled/labeled_articles_joined_clean.csv"))
