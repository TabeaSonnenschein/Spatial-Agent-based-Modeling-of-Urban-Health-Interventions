...
doc_txt = pd.read_csv(os.path.join(os.getcwd(), ("doi_10.1186_s12966-017-0471-5.csv")), encoding="latin1")
...
print(doc_txt.head())
csv = os.path.join(os.getcwd(), ("doi_10.1186_s12966-017-0471-5_withPOS.csv"))
doc_txt.to_csv(csv)