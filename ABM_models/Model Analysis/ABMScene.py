...
greenspace = gpd.read_feather(path_data+"SpatialData/Greenspace15mCity.feather")
greenspace = greenspace.explode(index_parts=True)
...
greenspace_centroids.to_feather(path_data+"SpatialData/GreenspaceCentroids15mCity.feather")
