...
for hour in range(24):
    exposure_df = pd.read_csv(f"AgentExposure_A{nb_agents}_M1_H{hour}.csv")
...
exposure_df_all.to_csv(f"AgentExposure_A{nb_agents}_M1_hourAsColumns.csv", index=False)
...
exposure_df_all = exposure_df_all.rename(columns={"agent": "agent_ID"})
exposure_df_all.to_csv(f"AgentExposure_A{nb_agents}_M1_hourAsRows.csv", index=False)
...
exposure_df.to_csv(f"AgentExposure_A{nb_agents}_M1_hourAsRowsMerged.csv", index=False)
